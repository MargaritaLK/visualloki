import {
  ...
  export const Base500yrDepthLayers = [
    {
        id: '500yr_base_max_depth_above_0_1m',
    ...
    {
        id: '500yr_base_max_depth_above_0_5',
        url: 'https://raw.githubusercontent.com/MargaritaLK/__data_experimental/main/P_Napier/depth_thresholds/500yr_base_max_depth_above_0_5m_wgs.geojson',
        style: {
            type: 'fill',
    ...
    {
        id: '500yr_base_max_depth_above_1m',
        url: 'https://raw.githubusercontent.com/MargaritaLK/__data_experimental/main/P_Napier/depth_thresholds/500yr_base_max_depth_above_1m_wgs.geojson',
        style: {
            type: 'fill',
    ...
    {
        id: '500yr_base_max_depth_above_1_5m',
        url: 'https://raw.githubusercontent.com/MargaritaLK/__data_experimental/main/P_Napier/depth_thresholds/500yr_base_max_depth_above_1_5m_wgs.geojson',
        style: {
            type: 'fill',
    ...
    {
        id: '500yr_base_max_depth_above_2m',
    ...
    {
        id: '500yr_base_max_depth_above_2_5m',
        url: 'https://raw.githubusercontent.com/MargaritaLK/__data_experimental/main/P_Napier/depth_thresholds/500yr_base_max_depth_above_2_5m_wgs.geojson',
        style: {
            type: 'fill',
